...
export const NEW_WEAPONS: Record<string, NewWeaponMeta> = {
  caltrop: {
    def: {
      ...
      hanja: '蒺藜',
      maxLevel: 8,
      desc: '이동 경로에 마름쇠 설치 · 접촉 시 폭발 + 둔화',
    },
    nameEn: 'Iron Caltrops',
    descEn: 'Caltrops along your path; blast + slow on contact',
  },
  poison: {
    def: {
      id: 'poison',
    ...
    nameEn: 'Venom Spring',
    descEn: 'Venom pool on the densest cluster; damage over time',
  },
  twinring: {
    def: {
      id: 'twinring',
      ...
      hanja: '雙輪',
      maxLevel: 8,
      desc: '전방 투척 부메랑 · 왕복하며 2회 관통 타격',
    },
    nameEn: 'Twin Rings',
    descEn: 'Boomerang chakrams; pierce twice on the round trip',
  },
};
