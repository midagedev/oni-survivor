...
export const COMPANION_BY_HERO: Record<string, CompanionDef> = {
  // 탄지로 → 스승 우로코다키 사콘지
  zhaoyun: { id: 'urokodaki', name: '우로코다키 사콘지', hanja: '鱗滝 左近次', portrait: 'urokodaki', sheet: 'apriority', charIndex: 10, attack: 'slash', damage: 32, cooldown: 1.1, special: 'rally', specialCd: 16, line: { ko: '판단이 늦다! 정신 차려라!', en: 'Too slow! Stay focused!' }, cr: 0.4, cg: 1.2, cb: 1.6 },
  // 기유 → 무주 토키토 무이치로
  guanyu: { id: 'tokito', name: '토키토 무이치로', hanja: '時透 無一郎', portrait: 'tokito', sheet: 'apriority', charIndex: 9, attack: 'slash', damage: 36, cooldown: 1.2, special: 'triplebolt', specialCd: 17, line: { ko: '무슨 구름이었더라... 흩어져라!', en: 'What shape was that cloud... Scatter!' }, cr: 0.6, cg: 1.5, cb: 1.8 },
  // 네즈코 → 아가츠마 젠이츠
  zhangfei: { id: 'zenitsu', name: '아가츠마 젠이츠', hanja: '我妻 善逸', portrait: 'zenitsu', sheet: 'apriority', charIndex: 12, attack: 'lightning', damage: 34, cooldown: 1.0, special: 'pierce', specialCd: 15, line: { ko: '네즈코 양은 내가 지킨다!! 벽력일섬!', en: 'I will protect Nezuko-chan!! Thunderclap!' }, cr: 2.2, cg: 1.8, cb: 0.3 },
  // 미츠리 → 나비저택 칸자키 아오이
  zhugeliang: { id: 'aoi', name: '칸자키 아오이', hanja: '神崎 アオイ', portrait: 'kanzaki_aoi', sheet: 'apriority', charIndex: 7, attack: 'lightning', damage: 30, cooldown: 1.4, special: 'firefan', specialCd: 18, line: { ko: '약탕 준비 완료! 즉시 치료하겠어요!', en: 'Medicine ready! Healing now!' }, cr: 0.5, cg: 1.6, cb: 0.8 },
  // 시노부 → 츠구코 츠유리 카나오
  huangzhong: { id: 'kanao', name: '츠유리 카나오', hanja: '栗花落 カナヲ', portrait: 'kanao', sheet: 'apriority', charIndex: 5, attack: 'slash', damage: 32, cooldown: 1.1, special: 'rally', specialCd: 16, line: { ko: '동전을 던졌어요... 함께 싸우겠어요.', en: 'I flipped a coin... I will fight with you.' }, cr: 1.6, cg: 0.8, cb: 1.2 },
  // 아카자 → 암주 히메지마 교메이
  sunshangxiang: { id: 'himejima', name: '히메지마 교메이', hanja: '悲鳴嶼 行冥', portrait: 'himejima', sheet: 'apriority', charIndex: 2, attack: 'slash', damage: 40, cooldown: 1.3, special: 'chargesweep', specialCd: 19, line: { ko: '남무아미타불... 극락왕생 하거라.', en: 'Namu Amida Butsu... Rest in peace.' }, cr: 1.8, cg: 1.2, cb: 0.5 },
  // 렌고쿠 → 하시비라 이노스케
  lvbu: { id: 'inosuke', name: '하시비라 이노스케', hanja: '嘴平 伊之助', portrait: 'inosuke', sheet: 'apriority', charIndex: 4, attack: 'slash', damage: 38, cooldown: 1.05, special: 'chargesweep', specialCd: 16, line: { ko: '저돌맹진! 저돌맹진!!', en: 'Inosuke is here! Pig rush!!' }, cr: 0.7, cg: 1.3, cb: 1.8 },
};
...
export const COMPANION_POOL: CompanionDef[] = [
  COMPANION_BY_HERO.zhaoyun,   // 우로코다키
  COMPANION_BY_HERO.guanyu,    // 토키토 무이치로
  COMPANION_BY_HERO.zhangfei,  // 젠이츠
  COMPANION_BY_HERO.zhugeliang, // 아오이
  COMPANION_BY_HERO.huangzhong, // 카나오
  COMPANION_BY_HERO.sunshangxiang, // 히메지마
  COMPANION_BY_HERO.lvbu,      // 이노스케
