...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ns,depthTest:!1,depthWrite:!1})}function Tv(a,t,e){const i=new Float32Array(sn),s=new L(0,1,0);return new Ot({name:"SphericalGaussianBlur",defines:{n:sn,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${a}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Co(),fragmentShader:`
		...
		`,blending:ns,depthTest:!1,depthWrite:!1})}function yu(){return new Ot({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Co(),fragmentShader:`
		...
		`,blending:ns,depthTest:!1,depthWrite:!1})}function Mu(){return new Ot({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Co(),fragmentShader:`
...
`)}const Fx={[Zh]:"Linear",[Kh]:"Reinhard",[Yh]:"Cineon",[wo]:"ACESFilmic",[Jh]:"AgX",[tc]:"Neutral",[Qh]:"Custom"};function Lx(a,t){const e=Fx[t];return e===void 0?(zt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+a+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+a+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Er=new L;function Dx(){Zt.getLuminanceCoefficients(Er);const a=Er.x.toFixed(4),t=Er.y.toFixed(4),e=Er.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${a}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);const T=M+g+r,y=M+p+o,A=Ru(s,s.VERTEX_SHADER,T),S=Ru(s,s.FRAGMENT_SHADER,y);s.attachShader(v,A),s.attachShader(v,S),e.index0AttributeName!==void 0?s.bindAttribLocation(v,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function C(P){if(a.debug.checkShaderErrors){const F=s.getProgramInfoLog(v)||"",G=s.getShaderInfoLog(A)||"",j=s.getShaderInfoLog(S)||"",N=F.trim(),W=G.trim(),k=j.trim();let K=!0,tt=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(K=!1,typeof a.debug.onShaderError=="function")a.debug.onShaderError(s,v,A,S);else{const at=Fu(s,A,"vertex"),ut=Fu(s,S,"fragment");Qt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
void main() {
  ...
  `},Rr=320,Pr=180,G1=2,Ma=90,Hu=4;class V1{composer;bloom;musouPass;postfx;renderer;bloomScale;pipEnabled;ring=[];ringCtx=[];ringFilled=0;ringHead=0;capCounter=0;replayT=-1;replayStart=0;replayFrames=[];pipWrap=null;pipCanvas=null;pipCtx=null;constructor(t,e,i){this.renderer=t,this.composer=new I1(t),this.composer.setPixelRatio(zh()),this.composer.setSize(window.innerWidth,window.innerHeight),this.composer.addPass(new U1(e,i)),this.bloomScale=so()?.5:1,this.bloom=new sa(new vt(window.innerWidth*this.bloomScale,window.innerHeight*this.bloomScale),.34,.4,.88),this.composer.addPass(this.bloom),this.musouPass=new vc(H1),this.composer.addPass(this.musouPass),this.postfx=new O1(so()),this.postfx.setSize(window.innerWidth,window.innerHeight),this.composer.addPass(this.postfx.pass),this.composer.addPass(new z1),this.pipEnabled=!so(),this.pipEnabled&&this.initPip()}initPip(){for(let n=0;n<Ma;n++){const r=document.createElement("canvas");r.width=Rr,r.height=Pr;const o=r.getContext("2d");if(!o){this.pipEnabled=!1;return}this.ring.push(r),this.ringCtx.push(o)}const t=document.createElement("div");t.style.cssText=["position:fixed","right:18px","bottom:18px","width:26vw","max-width:360px","aspect-ratio:16/9","z-index:28","pointer-events:none","display:none","border:2px solid rgba(232,201,103,0.85)","border-radius:6px","overflow:hidden","box-shadow:0 6px 24px rgba(0,0,0,0.6)"].join(";");const e=document.createElement("div");e.textContent="討伐 · 슬로 리플레이",e.style.cssText=["position:absolute","left:0","top:0","padding:2px 8px","font:600 12px/1.4 system-ui,sans-serif","color:#ffe9a8","background:linear-gradient(90deg,rgba(0,0,0,0.7),rgba(0,0,0,0))","letter-spacing:0.04em"].join(";");const i=document.createElement("canvas");i.width=Rr,i.height=Pr,i.style.cssText="width:100%;height:100%;display:block;";const s=i.getContext("2d");if(!s){this.pipEnabled=!1;return}t.appendChild(i),t.appendChild(e),document.body.appendChild(t),this.pipWrap=t,this.pipCanvas=i,this.pipCtx=s}playReplay(){if(!this.pipEnabled||this.replayT>=0||this.ringFilled<8)return;this.replayFrames.length=0;const t=this.ringFilled<Ma?0:this.ringHead;for(let e=0;e<this.ringFilled;e++)this.replayFrames.push(this.ring[(t+e)%Ma]);this.replayT=0,this.replayStart=performance.now(),this.pipWrap&&(this.pipWrap.style.display="block",this.pipWrap.animate([{opacity:0,transform:"translateY(12px) scale(0.94)"},{opacity:1,transform:"none"}],{duration:260,easing:"ease-out"}))}setMusou(t,e){this.musouPass.uniforms.uStrength.value=t,this.musouPass.uniforms.uTime.value=e,this.postfx.setMusou(t)}pulseBlur(t,e=0,i=0){this.postfx.pulseBlur(t,e,i)}pulseAberration(t){this.postfx.pulseAberration(t)}setSize(t,e){const i=zh();this.renderer.setPixelRatio(i),this.renderer.setSize(t,e),this.composer.setPixelRatio(i),this.composer.setSize(t,e),this.bloom.setSize(t*this.bloomScale,e*this.bloomScale),this.postfx.setSize(t,e)}render(){this.postfx.update(),this.composer.render(),this.pipEnabled&&this.pipTick()}pipTick(){if(this.replayT>=0){this.advanceReplay();return}++this.capCounter<G1||(this.capCounter=0,this.ringCtx[this.ringHead].drawImage(this.renderer.domElement,0,0,Rr,Pr),this.ringHead=(this.ringHead+1)%Ma,this.ringFilled<Ma&&this.ringFilled++)}advanceReplay(){const t=(performance.now()-this.replayStart)/1e3;if(this.replayT=t,t>=Hu||!this.pipCtx||this.replayFrames.length===0){this.endReplay();return}const e=Math.min(this.replayFrames.length-1,Math.floor(t/Hu*this.replayFrames.length));this.pipCtx.drawImage(this.replayFrames[e],0,0,Rr,Pr)}endReplay(){if(this.replayT=-1,this.replayFrames.length=0,this.capCounter=0,this.pipWrap){const t=this.pipWrap;t.animate([{opacity:1},{opacity:0}],{duration:260,easing:"ease-in"}).onfinish=()=>{t.style.display="none"}}}}const ca=55*Math.PI/180,W1=24,X1=Math.sin(ca),q1=Math.cos(ca),j1=1.1,$1=1.5,Gu=1.1,Z1=.08,K1=2.5,Y1=.3,Q1=.05,J1=.05,tb=1.32,Vu=2.2,eb=.55,Wu=1.8;function ml(a,t){const e=Math.sin(a*12.9898+t*78.233)*43758.5453;return(e-Math.floor(e))*2-1}const Xu=40;class ib{camera;sx={x:0,z:0};trauma=0;time=0;inited=!1;fovPunch=0;zoom=1;threat=0;speedFrac=0;cine=0;cineHold=0;azi=0;elevOff=0;offX=0;offZ=0;laX=0;laZ=0;laTX=0;laTZ=0;look=new L;constructor(){this.camera=new Di(Xu,window.innerWidth/window.innerHeight,.1,300)}onResize(t,e){this.camera.aspect=t/e,this.camera.updateProjectionMatrix()}addTrauma(t){this.trauma=Math.min(1,this.trauma+t)}punchFov(t){this.fovPunch=Math.max(-6,Math.min(6,this.fovPunch+t))}setThreat(t){this.threat=t<0?0:t>1?1:t}setLookAhead(t,e,i){const s=Math.min(1,i);this.speedFrac=s;const n=Math.hypot(t,e)||1;this.laTX=t/n*s*Vu*eb,this.laTZ=e/n*s*Vu}cinematic(t){this.cine=t}setCinematicPose(t,e,i,s=0,n=0){this.azi=t,this.elevOff=e,this.cineHold=i,this.offX=s,this.offZ=n}update(t,e,i){this.time+=t,this.laX+=(this.laTX-this.laX)*Math.min(1,Wu*t),this.laZ+=(this.laTZ-this.laZ)*Math.min(1,Wu*t);const s=e+this.laX,n=i+this.laZ;this.inited||(this.sx.x=s,this.sx.z=n,this.inited=!0);const r=1-Math.exp(-9*t);this.sx.x+=(s-this.sx.x)*r,this.sx.z+=(n-this.sx.z)*r,this.cine*=Math.exp(-t/.7),Math.abs(this.cine)<.002&&(this.cine=0);const o=Math.min(tb,1+this.threat*Y1-Q1*(1-this.threat)+J1*this.speedFrac);this.zoom+=(o-this.zoom)*Math.min(1,K1*t);const l=W1*Math.max(.5,this.zoom+this.cine+this.cineHold);Math.abs(this.fovPunch)>.001&&(this.fovPunch*=Math.exp(-t/.18),Math.abs(this.fovPunch)<.001&&(this.fovPunch=0),this.camera.fov=Xu+this.fovPunch,this.camera.updateProjectionMatrix());let h=X1,c=q1;if(this.elevOff!==0){const m=ca+this.elevOff;h=Math.sin(m),c=Math.cos(m)}const u=l*c,d=this.sx.x+this.offX,f=this.sx.z+this.offZ;if(this.azi!==0?this.camera.position.set(d+u*Math.sin(this.azi),l*h,f+u*Math.cos(this.azi)):this.camera.position.set(d,l*h,f+u),this.look.set(d,j1,f),this.camera.lookAt(this.look),this.trauma=Math.max(0,this.trauma-$1*t),this.trauma>0){const m=this.trauma*this.trauma,v=this.time*32;this.camera.position.x+=Gu*m*ml(v,1),this.camera.position.y+=Gu*m*ml(v,2),this.camera.rotation.z+=Z1*m*ml(v,3)}}}class sb{down=new Set;pressed=new Set;move={x:0,z:0};joy={x:0,z:0,active:!1};constructor(t=window){t.addEventListener("keydown",this.onKeyDown),t.addEventListener("keyup",this.onKeyUp),window.addEventListener("blur",()=>{this.down.clear()})}onKeyDown=t=>{nb.has(t.code)&&t.preventDefault(),this.down.has(t.code)||this.pressed.add(t.code),this.down.add(t.code)};onKeyUp=t=>{this.down.delete(t.code)};isDown(t){return this.down.has(t)}consumePressed(t){return this.pressed.has(t)?(this.pressed.delete(t),!0):!1}press(t){this.pressed.add(t)}poll(){if(this.joy.active){this.move.x=this.joy.x,this.move.z=this.joy.z;return}let t=0,e=0;(this.down.has("KeyD")||this.down.has("ArrowRight"))&&(t+=1),(this.down.has("KeyA")||this.down.has("ArrowLeft"))&&(t-=1),(this.down.has("KeyS")||this.down.has("ArrowDown"))&&(e+=1),(this.down.has("KeyW")||this.down.has("ArrowUp"))&&(e-=1),this.move.x=t,this.move.z=e}endFrame(){this.pressed.clear()}}const nb=new Set(["KeyW","KeyA","KeyS","KeyD","ArrowUp","ArrowDown","ArrowLeft","ArrowRight","Space"]);class ab{running=!1;last=0;cb;constructor(t){this.cb=t}start(){this.running||(this.running=!0,this.last=performance.now(),requestAnimationFrame(this.tick))}stop(){this.running=!1}tick=t=>{if(!this.running)return;let e=(t-this.last)/1e3;this.last=t,e>.033&&(e=.033),e<0&&(e=0),this.cb(e),requestAnimationFrame(this.tick)}}const Ns=48,Ga=64;function xc(a,t,e,i,s,n){const r=t+s*Ns,o=e+i*Ga;n.u=r/a.texW,n.v=1-(o+Ga)/a.texH}class rb{manifest;sgrade;apriority;soldiers;variants;constructor(t,e){this.manifest=t,this.sgrade=e.sgrade,this.apriority=e.apriority,this.soldiers=e.soldiers,this.variants=e.variants}soldierBlockPx(t){return t*4*Ns}variantBlocks(t){return this.manifest.sheets.soldiersVariants.variants[t]??[]}}function Fr(a,t,e){a.magFilter=oe,a.minFilter=oe,a.generateMipmaps=!1,a.colorSpace=Me,a.premultiplyAlpha=!1,a.flipY=!0,a.needsUpdate=!0;const i=t*Ns,s=e*Ga;return{texture:a,texW:i,texH:s,cellUvW:Ns/i,cellUvH:Ga/s}}async function ob(){const t="/oni-survivor/"+"assets/sprites/",i=await(await fetch(t+"manifest.json")).json(),s=new ja,n=c=>new Promise((u,d)=>{s.load(t+c,u,void 0,d)}),[r,o,l,h]=await Promise.all([n(i.sheets.sgrade.file),n(i.sheets.apriority.file),n(i.sheets.soldiers.file),n(i.sheets.soldiersVariants.file)]);return new rb(i,{sgrade:Fr(r,i.sheets.sgrade.cols,i.sheets.sgrade.rows),apriority:Fr(o,i.sheets.apriority.cols,i.sheets.apriority.rows),soldiers:Fr(l,i.sheets.soldiers.cols,i.sheets.soldiers.rows),variants:Fr(h,i.sheets.soldiersVariants.cols,i.sheets.soldiersVariants.rows)})}const Nn=a=>1-Math.pow(1-a,3),On=a=>a<.5?4*a*a*a:1-Math.pow(-2*a+2,3)/2,Nh=a=>a<0?0:a>1?1:a,qu=(a,t,e)=>{const i=Nh((e-a)/(t-a));return i*i*(3-2*i)},Lr=.4,gl=-.15,ju=-.08,lb=-.11,$u=.4,Dr=.6,vl=1.1,hb=.07,cb=.9,Zu=.45,xl=.7,ub=-.13,db=32,Ku=1,Yu=9,fb=.1,Qu=1.2,pb=.62,mb=-.12,Ju=6,td=.7,ed=4,gb=.05;class vb{rig;onReplay;musouActive=!1;musouT=0;musouEndT=-1;endAzi=0;endElev=0;endZoom=0;killcamT=-1;killcamCooldown=0;panT=-1;panDirX=0;panDirZ=0;deathT=-1;deathDirX=0;deathDirZ=0;allyT=-1;allyDirX=0;allyDirZ=0;vignette;replayPending=!1;constructor(t,e){this.rig=t,this.onReplay=e??null,this.vignette=document.createElement("div"),this.vignette.style.cssText=["position:fixed","inset:0","pointer-events:none","opacity:0","z-index:29","background:radial-gradient(ellipse at center, rgba(0,0,0,0) 34%, rgba(6,4,10,0.9) 100%)"].join(";"),document.body.appendChild(this.vignette)}onMusouStart(){this.musouActive=!0,this.musouT=0,this.musouEndT=-1,this.killcamT=-1,this.rig.addTrauma(.35),this.rig.punchFov(-2.5)}onMusouEnd(){if(!this.musouActive)return;const t=this.musouPose(this.musouT);this.endAzi=t.azi,this.endElev=t.elev,this.endZoom=t.zoom,this.musouActive=!1,this.musouEndT=0,this.rig.cinematic(-.11),this.rig.punchFov(4.5),this.rig.addTrauma(.6)}onMassKill(t){this.musouActive||this.musouEndT>=0||this.killcamCooldown>0||this.killcamT>=0||(this.killcamT=0,this.killcamCooldown=db,this.rig.addTrauma(.25),this.vignette.animate([{opacity:0},{opacity:.95,offset:.22},{opacity:.6,offset:.55},{opacity:0}],{duration:xl*1e3,easing:"ease-out"}))}onBossSpawn(t,e){const i=Math.hypot(t,e)||1;this.panDirX=t/i,this.panDirZ=e/i,this.panT=0}onBossDeath(t,e){const i=Math.hypot(t,e)||1;this.deathDirX=t/i,this.deathDirZ=e/i,this.deathT=0,this.panT=-1,this.onReplay?this.onReplay():this.replayPending=!0}onAllyJoin(t,e){if(this.musouActive||this.musouEndT>=0||this.panT>=0||this.deathT>=0||this.killcamT>=0)return;const i=Math.hypot(t,e)||1;this.allyDirX=t/i,this.allyDirZ=e/i,this.allyT=0}onDash(){this.rig.cinematic(-.1),this.rig.punchFov(2)}get wantsSkipInput(){return this.panT>=0}skip(){this.panT>=0&&(this.panT=-1),this.allyT>=0&&(this.allyT=-1)}consumeReplayTrigger(){return this.replayPending?(this.replayPending=!1,!0):!1}reset(){this.musouActive=!1,this.musouEndT=-1,this.killcamT=-1,this.killcamCooldown=0,this.panT=-1,this.deathT=-1,this.allyT=-1,this.replayPending=!1,this.rig.setCinematicPose(0,0,0,0,0)}update(t){this.killcamCooldown>0&&(this.killcamCooldown-=t);let e=0,i=0,s=0,n=0,r=0;if(this.musouActive){this.musouT+=t;const o=this.musouPose(this.musouT);e+=o.azi,i+=o.elev,s+=o.zoom}else if(this.musouEndT>=0){this.musouEndT+=t;const o=On(Nh(this.musouEndT/Zu));e+=this.endAzi*(1-o),i+=this.endElev*(1-o),s+=this.endZoom*(1-o),this.musouEndT>=Zu&&(this.musouEndT=-1)}if(this.killcamT>=0){this.killcamT+=t;const o=this.killcamT/xl,l=qu(0,.18,o)*(1-qu(.55,1,o));s+=ub*l,this.killcamT>=xl&&(this.killcamT=-1)}if(this.panT>=0){this.panT+=t;const o=this.panT/Ku,l=o<.5?Nn(o/.5):1-On((o-.5)/.5);n+=this.panDirX*Yu*l,r+=this.panDirZ*Yu*l,s+=fb*l,this.panT>=Ku&&(this.panT=-1)}if(this.deathT>=0){this.deathT+=t;const o=this.deathT/Qu,l=o<.45?Nn(o/.45):1-On((o-.45)/.55);e+=pb*l,s+=mb*l,n+=this.deathDirX*Ju*l,r+=this.deathDirZ*Ju*l,this.deathT>=Qu&&(this.deathT=-1)}if(this.allyT>=0)if(this.musouActive||this.musouEndT>=0||this.panT>=0||this.deathT>=0||this.killcamT>=0)this.allyT=-1;else{this.allyT+=t;const o=this.allyT/td,l=o<.5?Nn(o/.5):1-On((o-.5)/.5);n+=this.allyDirX*ed*l,r+=this.allyDirZ*ed*l,s+=gb*l,this.allyT>=td&&(this.allyT=-1)}this.rig.setCinematicPose(e,i,s,n,r)}musouPose(t){let e;if(t<Lr)e=gl*Nn(t/Lr);else if(t<.9){const n=On((t-Lr)/(.9-Lr));e=gl+(ju-gl)*n}else e=ju;const i=lb*Nn(Nh(t/.5));let s;if(t<Dr)s=$u*Nn(t/Dr);else if(t<vl){const n=On((t-Dr)/(vl-Dr));s=$u*(1-n)}else s=hb*Math.sin((t-vl)*cb);return{azi:s,elev:i,zoom:e}}}const Qe=12,$a=`
...
`,gi=28,ld=1.7,wl=14,U_=.6,zr=2.4,k_=2.6,z_=.14,N_=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * instanceMatrix * vec4(position, 1.0);
...
`;class B_{effects;mesh;dummy=new Ze;up=new L(0,1,0);backDir=new L(0,1,0);phase=new Uint8Array(gi);wait=new Float32Array(gi);fall=new Float32Array(gi);ttl=new Float32Array(gi);tx=new Float32Array(gi);tz=new Float32Array(gi);wx=new Float32Array(gi);wz=new Float32Array(gi);bdx=new Float32Array(gi);bdy=new Float32Array(gi);bdz=new Float32Array(gi);cur=0;constructor(t,e){this.effects=e;const i=new Jt(1,1);i.translate(0,.5,0);const s=new Ot({vertexShader:N_,fragmentShader:O_,transparent:!0,blending:as,side:ti,depthWrite:!1,depthTest:!0});this.mesh=new Se(i,s,gi),this.mesh.instanceMatrix.setUsage(St),this.mesh.frustumCulled=!1,this.mesh.count=0,this.mesh.renderOrder=4,t.add(this.mesh)}volley(t){if(t.length===0)return;const e=Math.random()*Math.PI*2,i=Math.cos(e),s=Math.sin(e);for(const n of t){const r=Math.max(.05,n.t);this.effects.spawnTelegraph(Hh,n.x,n.z,0,ld*2,ld*2,0,r,1,.4,.14),this.alloc(n.x,n.z,r,i,s)}}alloc(t,e,i,s,n){const r=this.cur;this.cur=(this.cur+1)%gi;const o=Math.min(i,U_);this.phase[r]=1,this.wait[r]=Math.max(0,i-o),this.fall[r]=o,this.ttl[r]=o,this.tx[r]=t,this.tz[r]=e,this.wx[r]=s,this.wz[r]=n;const l=s*zr,h=n*zr,c=Math.hypot(l,wl,h)||1;this.bdx[r]=l/c,this.bdy[r]=wl/c,this.bdz[r]=h/c}update(t){let e=0;for(let i=0;i<gi;i++){const s=this.phase[i];if(s===0)continue;if(s===1){if(this.wait[i]-=t,this.wait[i]>0)continue;this.phase[i]=2,this.ttl[i]=this.fall[i]}if(this.ttl[i]-=t,this.ttl[i]<=0){this.impact(i),this.phase[i]=0;continue}const n=this.ttl[i]/this.fall[i],r=1-(1-n)*(1-n),o=this.tx[i]+this.wx[i]*zr*r,l=wl*r,h=this.tz[i]+this.wz[i]*zr*r;this.dummy.position.set(o,l,h),this.backDir.set(this.bdx[i],this.bdy[i],this.bdz[i]),this.dummy.quaternion.setFromUnitVectors(this.up,this.backDir),this.dummy.scale.set(z_,k_,1),this.dummy.updateMatrix(),this.mesh.setMatrixAt(e,this.dummy.matrix),e++}this.mesh.count=e,this.mesh.instanceMatrix.needsUpdate=!0}impact(t){const e=this.tx[t],i=this.tz[t];this.effects.spawnRing(e,i,1.6,.75,.5,.28,.32),this.effects.spawnDecal?.(e,i,1.3,.85,.4,.16)}reset(){this.phase.fill(0),this.cur=0,this.mesh.count=0}}const H_=Ns/Ga,G_=.25,V_=.4;class W_{mesh;mat;time=0;vis=0;boundTex=null;constructor(t){const e=new Jt(H_,1);e.translate(0,.5,0),e.rotateX(Lf),this.mat=new Ot({uniforms:{uMap:{value:null},uUvOffset:{value:new vt(0,0)},uCellUv:{value:new vt(1,1)},uTexel:{value:new vt(1,1)},uTime:{value:0},uAlpha:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() { vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }
      `,fragmentShader:`
        precision highp float;
